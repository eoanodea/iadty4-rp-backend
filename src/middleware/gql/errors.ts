 ...
 * Version 1.0.0
 * File Created: Monday, 7th December 2020 10:30:31 pm
 ...
 * -----
 * File Description:
 * Last Modified: Monday, 7th December 2020 10:39:14 pm
 * Modified By: Eoan O'Dea (eoan@web-space.design>)
 * -----
 * Copyright 2020 WebSpace, WebSpace
 */
 ...
 *
 */
export const ErrorInterceptor: MiddlewareFn<ApolloContext> = async (
  { context, info },
  next
) => {
  return next()
